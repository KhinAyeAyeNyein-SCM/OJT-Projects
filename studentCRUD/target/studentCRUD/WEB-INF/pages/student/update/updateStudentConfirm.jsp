              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <ul class="list-group list-group-unbordered mb-3">
                    <li class="list-group-item"><b>Roll_Number</b> <a
                      class="float-right">${updateStudentForm.roll_number } <input
                        type="hidden" name="roll_number"
                    ...
                    <li class="list-group-item"><b>Major</b> <a
                      class="float-right">${updateStudentForm.major } <input
                        type="hidden" name="major"
                    ...
                    <li class="list-group-item"><b>Email</b> <a
                      class="float-right">${updateStudentForm.email } <input
                  ...
                  <a class="btn btn-secondary" href="${pageContext.request.contextPath}/updateStudent?id=${updateStudentForm.id}">Cancel</a>
