        ...
        <div class="forms-mr">
          <div class="col-sm-6 col-md-6 form-detail">
            ...
            <form:form class="form-create" action="updateStudentConfirm"
              method="POST" id="form" modelAttribute="editedStudentForm">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <a class="btn btn-secondary" href="${pageContext.request.contextPath}/updateStudent?id=${student.id}">Reset</a>
